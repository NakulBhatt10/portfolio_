...
import desktopBg from '../../assets/images/back.jpg';
import profileImage from '../../assets/images/back.jpg';

const roles = ['software', 'full-stack', 'frontend', 'backend'];

const Home = () => {
  const handleConnectClick = () => {
    window.open('https://www.linkedin.com/in/nakul-bhatt-157aba24a/', '_blank');
  };
      ...
      <div className="hero__content">
        ...
        <div className="profile-card">
          <div className="profile-image">
            <img src={profileImage} alt="Nakul Bhatt" />
          </div>
        </div>
